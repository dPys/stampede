...
if [ -z "${FSL_FIX_MATLAB_ROOT}" ]; then
       FSL_FIX_MATLAB_ROOT=/opt/apps/matlab/2016a
...
FSL_FIX_MCRROOT=/work/04171/dpisner/lonestar/MATLAB_Compiler_Runtime
...
FSL_FIX_MLOPTS="-nodisplay -nodesktop -nosplash"
